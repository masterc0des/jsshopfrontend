...
function Login() {
  ...
  function handleSubmit(event) {
    ...
    fetch("http://localhost:8080/api/login", { method: "POST", headers: {'Content-Type': 'application/json'}, body: JSONData })
  ...
  return (
    <div id='div-login'>
          ...
          <form id="login-form" action="/login" onSubmit={handleSubmit}>
